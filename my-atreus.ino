...
KEYMAPS(
  ...
  (
      ...
      ,Key_Z    ,Key_X     ,Key_C     ,Key_V          ,Key_B         ,Key_PlayPause
      ,Key_Mute ,Key_VolDn ,Key_VolUp ,LT(NUM,Escape) ,LT(NAV,Space) ,SFT_T(Tab)

                      ,Key_Y             ,Key_U      ,Key_I        ,Key_O        ,Key_P
                      ,Key_H             ,Key_J      ,Key_K        ,Key_L        ,Key_Semicolon
       ,Key_NextTrack ,Key_N             ,Key_M      ,Key_Comma    ,Key_Period   ,Key_Question
       ,SFT_T(Enter)  ,LT(SYM,Backspace) ,Key_Delete ,Key_BrightUp ,Key_BrightDn ,Key_Sleep
  ),
